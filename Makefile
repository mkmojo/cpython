...
abs_srcdir=	/Users/qqy/workspace/Python-2.7.8
abs_builddir=	/Users/qqy/workspace/Python-2.7.8
...
CFLAGS=		$(BASECFLAGS) -g3 -gdwarf-2 $(OPT) $(EXTRA_CFLAGS)
...
BLDSHARED=	$(CC) -bundle -undefined dynamic_lookup $(LDFLAGS)
...
CONFIG_ARGS=	 'CC=/usr/bin/gcc' 'CXX=/usr/bin/g++' 'CFLAGS=-g3 -gdwarf-2' 'CXXFLAGS=-g3 -gdwarf-2'
...
HOST_GNU_TYPE=  x86_64-apple-darwin13.3.0
